            ...
            render = (e)=>(
                <div className="rounded-2xl bg-white p-4  py-1 md:p-0 xl:pr-8  mt-5">
                    <select
                        ...
                        className="outline-none text-blue text-xl p-0 uppercase text-left text-raleway w-full md:p-8 md:py-3 "
                        >
                        {options?.map((option) => (
                            <option
                            key={option}
        ...
        case "textarea":
            render = (e)=>(
                <textarea
                    ...
                    className="border-b-2 border-white/50 focus:border-b-2 outline-none focus:border-white w-[80%] h-24 md:h-auto md:text-xl resize-none"
                />
            );
            break;
        default:
            render = (e)=>(
                <input
                    ...
                    className="border-b-2 border-white/50 focus:border-b-2 outline-none focus:border-white w-[80%] autofill:!bg-transparent"
                />
            );
            break;
    }
